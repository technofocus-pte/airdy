...
10. Select **Networking** under **Security + networking** from the left pane. Select the **Private endpoint connections** tab, select the **Connection name** whose Connection state is in **Pending** state and click on
